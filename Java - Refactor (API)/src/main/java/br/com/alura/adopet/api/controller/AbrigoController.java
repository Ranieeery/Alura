...
public class AbrigoController {
    ...
    public AbrigoController(AbrigoRepository repository, AbrigoService service) {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<String> cadastrar(@RequestBody @Valid SolicitacaoCadastrarAbrigoDTO abrigo) {
        try {
